...
def mouse_pressed(event):
    ...
    number = 40
    canvas.create_oval(x - number, y - number + 100, x + number, y + number + 100, fill='red', width=4)
    number = 20
    canvas.create_oval(x - number, y - number + 100, x + number, y + number + 100, fill='orange', width=4)
    canvas.create_oval(x, y + 100, x, y + 100, fill='yellow', width=4)
