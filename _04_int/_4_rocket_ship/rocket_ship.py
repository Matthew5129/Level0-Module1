...
def mouse_pressed(event):
    ...
    canvas.create_oval(x, y, x + 100, y - 50, fill='red', width=4)
    canvas.create_oval(x, y, x + 50, y - 25, fill='orange', width=2)
    canvas.create_oval(x, y, x + 25, y - 12.5, fill='yellow', width=1)
